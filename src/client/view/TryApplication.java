...
public class TryApplication extends JFrame {
	 ...
	 * Create the frame.
	 */
	public TryApplication(final Model model) {
		this.model = model;
		...
		btnCreateGame.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new CreateGameController(TryApplication.this, model).process();
			}
		});
		...
		btnJoinGame.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new JoinGameController(TryApplication.this, model).process();
			}
		});
		...
		btnStartPratice.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new StartPraticeController(TryApplication.this,model).process();
			}
		});
