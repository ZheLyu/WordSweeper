...
public class ResetGameResponseControllerTest extends TestCase {
	...
	public void testProcess() {
		...
		String xmlString = Message.responseHeader("someMessageID") + "<resetGameResponse gameId='somePlace'></resetGameResponse></response>";
		
		Message response = new Message(xmlString);
		
		boolean result = new ResetGameResponseController(client, model).process(response);
